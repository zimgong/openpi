...
class LeRobotRobocasaDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        # Since we want to support inference in LeRobot, which does not have the data transform pipeline, 
        # we use abs action directly (although this is not optimal). 

        # TODO: uncomment this out once we have updated the pipeline to 
        # the delta action transform
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotRobocasaDataConfig(
            repo_id="robocasa/PnPCounterToStoveMG",
            base_config=DataConfig(
